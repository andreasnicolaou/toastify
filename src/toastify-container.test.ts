...
describe('ToastifyContainer', () => {
  ...
  test('should create and append a container to the body', () => {
  ...
  test('should apply the correct class name based on the position bottom-left', () => {
  ...
  test('should return the correct HTMLElement via the element getter', () => {
    toastifyContainer = new ToastifyContainer('top-right');
